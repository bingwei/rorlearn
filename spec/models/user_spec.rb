require 'spec_helper'
describe User do
  before { @user = User.new(name: "Example", email: "user@ex.com",
                            password: "foobar",
  ...
  describe "when email format is valid" do
    it "should be valid" do
      addresses = %w{foo@bar..com user@foo.COM user_at-a_f@org.b ex.user@foo.jp foo@barb.com fo+bo@bar.com}
  ...
  describe "when password and password_confirmatioin do not present" do
    before do
